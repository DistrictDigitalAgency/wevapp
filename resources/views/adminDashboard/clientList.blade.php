                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr class="border-0">
                                            ...
                                            <th class="text-center border-0">Organization</th>
                                            <th class="text-center border-0">Business type</th>
                                            <th class="text-center border-0">Name</th>
                                            <th class="text-center border-0">Position</th>
                                            <th class="text-center border-0">Account Amount</th>
                                            <th class="text-center border-0">Created at</th>
                                        ...
                                        @foreach($clients as $client)
                                            ...
                                            <td class="text-center">{{$client->organization}}</td>
                                            <td class="text-center">{{$client->businesstype}}</td>
                                            <td class="text-center">{{$client->name}}</td>
                                            <td class="text-center">{{$client->job}}</td>
                                            <td class="text-center">{{$client->amount}}</td>
                                            <td class="text-center">{{$client->created_at}}</td>
                                            <td class="text-center"><a href="{{route('admin.client.detail',['id'=>$client->id ])}}" class="btn btn-outline-light btn-block">View Details</a></td>
