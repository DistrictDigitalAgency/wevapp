            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin.clientStats') }}"  aria-expanded="false" ><i class="fab fa-fw fa-wpforms"></i>Clients statistics</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-89 col-lg-9 col-md-9 col-sm-6 col-8">
                        <div class="page-header">
                            <h2 class="pageheader-title">Clients statistics</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="breadcrumb-link">Admin Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Clients statistics</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of clients</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$nbClients}}</h1>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of campaigns</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$nbCampaign}}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of asked questions</h5>
                                <div class="metric-value d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted">question # per campaign</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$nbQuestions/$nbCampaign}}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of delivred Camp.</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$delivredCampaigns}}</h1>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of in-transit Camp.</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$intransitCampaigns}}</h1>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of approved Camp.</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">{{$approvedCampaigns}}</h1>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="border-3 border-top border-top-primary card text-center">
                            <div class="card-body">
                                <h5 class="text-muted"># of pending Camp.</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1" style="color:red;">{{$pendingCampaigns}}</h1>
                                </div>
