                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-6 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Campaign id: {{$campaign->id}}</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('my_campaigns') }}" class="breadcrumb-link">Launched campaigns</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Campaign id: {{$campaign->id}}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
